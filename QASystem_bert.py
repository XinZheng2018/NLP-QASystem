...
def find_closest_distance_to_any_keyword(loc_ans, list_index):
    ...
    return distance
def answer_candidate(question,id,top_n_passages):
...
def answer_extract(final_answer, single_question):
    """
    ...
    np = single_question[3]
    tag_looing_for = single_question[2]
    keyword_list = single_question[0]

    for ele in final_answer:
...
if __name__ == "__main__":
    ...
    for n in n_list:
        ...
        top_n_questions = answer_candidate(question,n,top_n_passages)
        anwer_list_0, list_answer_type_0, list_locality_0 = answer_extract(top_n_questions,full_question_info[n])
