    ...
    for ele in top_n_passages:
        ...
        if np:
            ...
            if tag_looking_for[0] == "CD":
                ...
                find_tag = different_pattern_np_extractor(ele,keyword_list,list_index,list_answer_type,answer_list,list_of_locality,\
                                                          1.0,1)
                # np_parser_list = []
                # t_list = []
...
def tune_param(question):
    ...
    #
    # num_of_top_candidates= [20,25,27,30]
    # chunk_num = [30, 40]
    #test
    ...
    predict(question,topn,chunk)
    eval.evaluate('./training/qadata/answer_patterns.txt', 'prediction_file.txt',True)
